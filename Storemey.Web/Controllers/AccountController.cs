...
namespace Storemey.Web.Controllers
{
    public class AccountController : StoremeyControllerBase
    {
        ...
        public async Task<JsonResult> Login(LoginViewModel loginModel, string returnUrl = "", string returnUrlHash = "")
        {
            ...
            if (returnUrl == "/")
            {
                string redirectURL = PasswordHelper.Aes256CbcEncrypter.Encrypt(StoremeyConsts.SequireServerType + loginModel.TenancyName + "." + StoremeyConsts.DomainName + "/Home/point&LoadingTimeinsecond=2");
                returnUrl = StoremeyConsts.SequireServerType + loginModel.TenancyName + "." + StoremeyConsts.DomainName + "/Home/Loading?redirectURL=" + redirectURL;
            }
        ...
        public async Task<JsonResult> Registertenant(RegisterTenantViewModel RegiterModel, string returnUrl = "", string returnUrlHash = "")
        {
            ...
            //if (returnUrl == "/")
            //{
            string redirectURL = PasswordHelper.Aes256CbcEncrypter.Encrypt(StoremeyConsts.SequireServerType + RegiterModel.RegStoreName + "." + StoremeyConsts.DomainName + "/Account/login?storename=" + RegiterModel.RegStoreName + "&LoadingTimeinsecond=30");
            returnUrl = StoremeyConsts.SequireServerType + StoremeyConsts.DomainName + "/Home/Loading?redirectURL=" + redirectURL;
            //}
        ...
        public async Task CreateNewRegisterAsync(RegisterTenantViewModel RegiterModel, string returnUrl = "", string returnUrlHash = "", string previousTenant = "")
        {
            ...
            if (returnUrl == "/")
            {
                string redirectURL = PasswordHelper.Aes256CbcEncrypter.Encrypt(StoremeyConsts.SequireServerType + RegiterModel.RegStoreName + "." + StoremeyConsts.DomainName + "/Account/login?storename=" + RegiterModel.RegStoreName + "&LoadingTimeinsecond=150;");
                returnUrl = StoremeyConsts.SequireServerType + RegiterModel.RegStoreName + "." + StoremeyConsts.DomainName + "/Home/Loading?redirectURL=" + redirectURL;
            }
