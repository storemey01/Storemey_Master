...
! function (i) {
    ...
    (e = function () {
        ...
        if (this.$slideTrack != null && this.$slideTrack != undefined) {
        ...
        if (e.$slideTrack != null && e.$slideTrack != undefined &&  e.$slideTrack.find(".slick-cloned") != null) {
        ...
        for (var s = e.currentSlide, n = s + e.options.slidesToShow; s < n; s++)
            if (e.$slides != null && e.$slides != undefined) { e.$slides.eq(s).attr("tabindex", 0) } ;
