...

{
    ...
    static class Aes256CbcEncrypter

    {
        ...
        public static string Encrypt(string plainText, string key = "8UHjPgXZzXCGkhxV2QCnooyJexUzvJrO")
        ...
        public static string Decrypt(string plainText, string key = "8UHjPgXZzXCGkhxV2QCnooyJexUzvJrO")
